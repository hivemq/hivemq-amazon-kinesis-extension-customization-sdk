...
* Transform a MQTT PUBLISH into multiple or none Amazon Kinesis messages.
* Transform a Amazon Kinesis message into multiple or none MQTT PUBLISHES.
...
----
implementation("com.hivemq:hivemq-amazon-kinesis-extension-customization-sdk:4.14.0")
----
